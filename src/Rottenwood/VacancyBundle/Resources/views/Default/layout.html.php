...
<head>
    ...
    <!-- Fonts -->
    <link type="text/css" href="<?php echo $view['assets']->getUrl('assets/css/font-awesome.css') ?>" rel="stylesheet"/>
    <!-- Scripts -->
    ...
    <script type="text/javascript" src="<?php echo $view['assets']->getUrl('assets/js/bootstrap-confirmation.js') ?>"></script>
</head>
<body>
